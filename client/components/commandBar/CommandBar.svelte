<script lang="ts">
  ...
  import SearchActionResults from "@nucleum/components/commandBar/SearchActionResults.svelte";
  import CmdResults from "@nucleum/components/commandBar/CmdResults.svelte";
