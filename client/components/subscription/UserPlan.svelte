<script lang="ts">
  ...
  import type { IPlan, IBillingAddress } from "@nucleum/components/subscription/userPlan.type";
  import { BillingCycle } from "@nucleum/components/subscription/userPlan.type";
  import PlanCard from "@nucleum/components/subscription/elements/PlanCard.svelte";
  import FullScreenCloseButton from "@21n/elements/button/FullScreenCloseButton.svelte";
  import { Action } from "@21n/types/action.enum";
  import account from "@nucleum/stores/account.store";
  import { SUBSCRIPTION_PLANS } from "@nucleum/components/subscription/userPlan.utils";
  import BillingAddressCapture from "@nucleum/components/subscription/BillingAddressCapture.svelte";
