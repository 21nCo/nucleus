<script lang="ts">
  ...
  import { BillingCycle, PlanType } from "@nucleum/components/subscription/userPlan.type";
  import {
    PlanStatus,
    UserDataMode,
    type IUserPlan
  ...
  import DiscountBanner from "@nucleum/components/subscription/elements/DiscountBanner.svelte";
