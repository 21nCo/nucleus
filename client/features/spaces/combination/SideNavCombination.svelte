<script lang="ts">
  ...
  import { ActiveCombinationStore } from "@nucleum/features/spaces/combination/combination.store";
  import SideNavCombinationNavItem from "@nucleum/features/spaces/combination/SideNavCombinationNavItem.svelte";
  import SideNavCombinationResourcePicker from "@nucleum/features/spaces/combination/SideNavCombinationResourcePicker.svelte";
  import CombinationResourceRenderer from "@nucleum/features/spaces/combination/CombinationResourceRenderer.svelte";
  import CombinationTOC from "@nucleum/features/spaces/combination/CombinationTOC.svelte";
  import { findItemPath, getItemByPath } from "@nucleum/features/spaces/combination/combination.utils";
